"""Show how proportional gain Kp affects DC motor speed control."""
...
def _print_results(results):
    """Print Kp tuning metrics."""
    print("Kp Tuning for DC Motor Speed Control:")
    print("Higher Kp usually responds faster.")
    print("Too much Kp can cause overshoot or aggressive voltage.")
    print()
    print("Kp      Final Speed   Final Error   Overshoot   Settling Time   Max Voltage")
...
def _draw_plots(simulations, target_speed):
    """Draw speed responses for the Kp sweep."""
    ...
    axes[0].set_title("Effect of Kp on Motor Speed Response")
...
def main():
    """Run a proportional gain tuning comparison."""
    target_speed = 80.0
    Kp_values = [0.08, 0.16, 0.28, 0.45]
    cases = [
        {"label": f"Kp = {Kp}", "Kp": Kp, "Ki": 0.0, "Kd": 0.0}
        for Kp in Kp_values
    ]
